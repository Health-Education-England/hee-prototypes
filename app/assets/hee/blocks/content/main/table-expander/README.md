...
<div class="hee-card--table">
    ...
    <details class="nhsuk-details nhsuk-expander" nhsuk-polyfilled="true" id="nhsuk-details0">
      ...
      <div class="nhsuk-details__text" id="nhsuk-details__text0" aria-hidden="true">
        <div aria-rowcount="3" class="hee-card--table__container" role="table">
          <div class="hee-card--table__row" role="row">
            <span class="hee-card--table__row__heading" role="cell">Defence Medical Services (DMS)</span>
            <span class="hee-card--table__row__content" role="cell"> 1 </span>
          </div>
          <div class="hee-card--table__row" role="row">
            <span class="hee-card--table__row__heading" role="cell">No of Posts 2013 - indicitive</span>
            <span class="hee-card--table__row__content" role="cell"> 7 </span>
          </div>
          <div class="hee-card--table__row" role="row">
            <span class="hee-card--table__row__heading" role="cell">Competition ratios 2022 data - Ratio</span>
            <span class="hee-card--table__row__content" role="cell"> 6 (6:37) </span>
          </div>
          <div class="hee-card--table__row" role="row">
            <span class="hee-card--table__row__heading" role="cell">Job/Programme Descriptions</span>
            <span class="hee-card--table__row__content" role="cell">
